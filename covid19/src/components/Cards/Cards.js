    ...
    return (
        <div>
                <div class="card text-white bg-primary mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><CountUp start={0} end={confirmed.value} duration={2.5} separator="," /></h5>
                ...
                <div class="card text-white bg-success mb-3" >
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><CountUp start={0} end={recovered.value} duration={2.5} separator="," /></h5>
                        <p class="card-text">{new Date (lastUpdate).toDateString()}</p>
                ...
                <div class="card text-white bg-danger mb-3" >
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><CountUp start={0} end={deaths.value} duration={2.5} separator="," /></h5>
                        <p class="card-text">{new Date (lastUpdate).toDateString()}</p>
